    ...
    <div className="min-h-screen bg-white dark:bg-slate-900 relative overflow-hidden flex items-center justify-center px-4">
      ...
      <Card className="w-full max-w-md text-center relative z-10 bg-white dark:bg-slate-800 border-[#e0e0e0] dark:border-slate-700 shadow-2xl">
        <CardHeader className="space-y-2">
          <div className="mx-auto w-16 h-16 bg-[#7b1fa2] rounded-full flex items-center justify-center shadow-md">
            <Search className="w-8 h-8 text-white" />
          </div>
          <CardTitle className="text-2xl font-bold text-[#212121] dark:from-slate-100 dark:via-purple-200 dark:to-pink-200">
            Page Not Found
          </CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Button asChild className="w-full bg-[#1976d2] hover:bg-[#1565c0] text-white shadow-md hover:shadow-lg">
              <Link href="/dashboard">
